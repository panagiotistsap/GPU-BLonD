...
def kick(dt, dE, voltage, omega_rf, phi_rf, charge, n_rf, acceleration_kick, dummy=None):
...
def drift(dt, dE, solver, t_rev, length_ratio, alpha_order, eta_0,
          eta_1, eta_2, alpha_0, alpha_1, alpha_2, beta, energy, dummy=None):
...
def slice(beam_dt, profile, cut_left, cut_right, dummy=None):
