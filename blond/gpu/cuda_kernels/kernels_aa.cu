...
{   
    ...
    atomicAdd(&(res[0]),my_sum);
            ...
            extern "C"
            __global__
            void gpu_trapz_stage1(double *out, double *y, double x, int sz,
            ...
            extern "C"
            __global__
            void gpu_trapz_stage2(double *out, const double *pycuda_reduction_inp, double *y, double x, int sz,
            unsigned int seq_count, unsigned int n)
            {
            // Needs to be variable-size to prevent the braindead CUDA compiler from
            // running constructors on this array. Grrrr.
            ...
            extern "C"
            __global__
            void mean_non_zeros_stage1(double *out, double *x, double *id,
            unsigned int seq_count, unsigned int n)
            {
            // Needs to be variable-size to prevent the braindead CUDA compiler from
            // running constructors on this array. Grrrr.
            ...
            extern "C"
            __global__
            void mean_non_zeros_stage2(double *out, const double *pycuda_reduction_inp, double *x, double *id,
            unsigned int seq_count, unsigned int n)
            {
            // Needs to be variable-size to prevent the braindead CUDA compiler from
            // running constructors on this array. Grrrr.
            ...
            extern "C"
            __global__
            void stdKernel_stage1(double *out, double *x, double *y, double m,
            unsigned int seq_count, unsigned int n)
            {
            // Needs to be variable-size to prevent the braindead CUDA compiler from
            // running constructors on this array. Grrrr.
            ...
            extern "C"
            __global__
            void stdKernel_stage2(double *out, const double *pycuda_reduction_inp, double *x, double *y, double m,
            unsigned int seq_count, unsigned int n)
            {
            // Needs to be variable-size to prevent the braindead CUDA compiler from
            // running constructors on this array. Grrrr.
            ...
            extern "C"
            __global__
            void sum_non_zeros_stage1(double *out, double *x,
            unsigned int seq_count, unsigned int n)
            {
            // Needs to be variable-size to prevent the braindead CUDA compiler from
            // running constructors on this array. Grrrr.
            ...
            extern "C"
            __global__
            void sum_non_zeros_stage2(double *out, const double *pycuda_reduction_inp, double *x,
            unsigned int seq_count, unsigned int n)
            {
            // Needs to be variable-size to prevent the braindead CUDA compiler from
            // running constructors on this array. Grrrr.
