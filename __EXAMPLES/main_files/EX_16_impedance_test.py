...
from gpublond.impedances.impedance import InducedVoltageFreq, InducedVoltageTime
from gpublond.impedances.impedance import InductiveImpedance, TotalInducedVoltage
