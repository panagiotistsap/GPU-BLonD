...
from cuprof import region_timer,report,enable,save_report
...
worker.initDLB('reportonly,100,,,',100)
...
for turn in range(0,n_iterations):
    ...
    with region_timer('voltage_sum',timing_kind) as rt:
